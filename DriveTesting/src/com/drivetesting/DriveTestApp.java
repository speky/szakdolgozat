...
public class DriveTestApp extends Application implements TestSubject, PhoneStateSubject {
	...
	public void onCreate() {
		...
		if (dataStorage.querySpecifiedTestByName("testName1").size() == 0) {
			...
			/*dataStorage.insert(1,"testName1", 47.497142, 19.070572, 10, 3, 0.0, 102.89, 0.0, 0, 0, 1200, 38392, 216, 30, 2, "HSPA", "2014-04-20 08:10:25");
			dataStorage.insert(1,"testName1", 47.496517, 19.068228, 9, 3, 0.0, 127.49, 0.0, 0, 0, 1200, 38392, 216, 30, 2, "HSPA", "2014-04-20 08:10:45");
			dataStorage.insert(1,"testName1", 47.495844, 19.066064, 5, 2, 0.0, 100.10, 0.0, 0, 0, 1200, 38392, 216, 30, 2, "EDGE", "2014-04-20 08:10:65");
			dataStorage.insert(1,"testName1", 47.495169, 19.063558, 8, 3, 0.0, 121.29, 0.0, 0, 0, 1200, 38392, 216, 30, 2, "HSPA", "2014-04-20 08:10:85");
			*/		
